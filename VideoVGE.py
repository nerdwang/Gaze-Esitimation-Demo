...
def video_VGE(modelPath='./model256_20.pth'):
    ...
    out = cv.VideoWriter('./outputVideos/outputVGE.avi', fourcc, 20.0, (640, 480))
    ...
    vidcap = cv.VideoCapture('./outputVideos/outputVGE.avi')
    ...
    size = (640,480)
    out = cv.VideoWriter('./outputVideos/VideoVGE.avi', cv.VideoWriter_fourcc(*'XVID'), 20.0, size)
